...
export const Card = ({
  ...
  return (
    <div
      className={`relative aspect-video w-full overflow-hidden rounded-2xl [&_span]:transition-opacity [&_span]:duration-400 ${reveal ? "reveal-false:[&_span]:opacity-0" : "group"}`}
    >
